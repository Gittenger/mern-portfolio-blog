...
const Home = () => {
	...
	return (
		<HomePageContainer>
			<div className="intro-text text-box" data-sal="fade" data-sal-duration="800">
			...
			<div className="text-box page-desc" data-sal="fade" data-sal-delay="200">
				<PSmall>
					This web page was built using the MERN stack and deployed using a virtual
					private server (VPS) with Amazon Web Services (AWS). I built a simple
					framework on top of React to help me quickly develop this UI and any others
					in the future.
				</PSmall>
			</div>
			<div className="text-box list-header" data-sal="fade" data-sal-delay="200">
			...
			<div className="text-box project-desc" data-sal="fade" data-sal-delay="200">
				<PSmall>
					In my years of study, I have tried lots of things in an effort to broaden
				...
				{dataProcessed ? (
					Object.keys(data).map((project, i) => (
						<div class="project-link">
							<Link to={`/portfolio/${data[project].slug}`}>{data[project].name}</Link>
						</div>
					))
				) : (
					<Spinner />
			...
			<div className="text-box cta" data-sal="fade" data-sal-delay="200">
				<P className="cta-leading">
					...
					currently looking for an employer with whom I'll be a good fit. I'm looking
					for work in the New York City, New Jersey, and Philadelphia areas -- or
					remote work.
				</P>
				<PSmall className="cta-sub">
					If you'd like to discuss work or collaboration opportunities, I'd love to
					chat with you. Please, drop me a line:
				</PSmall>
